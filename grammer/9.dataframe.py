...
print(type(item.code_df_kospi.shape[0]))
for i in range(item.code_df_kospi.shape[0]):
    if('삼성' in item.code_df_kospi.loc[i,'code_name'] ):
        print(i,item.code_df_kospi.loc[i,'code_name'],item.code_df_kospi.loc[i,'code'])
