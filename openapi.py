...
### openapi는 32bit 환경이야, 하지만 다른 패키지를 설치하는경우 자동적으로 64bit용으로 설치하는 경우가 있어
### 그런경우 시스템 충돌이 나서 프로그램이 동작하지 않으니 아나콘다에서 set CONDA_FORCE_32BIT=1 을 입력해
### 32비트환경으로 만든뒤 패키지를 설치해
